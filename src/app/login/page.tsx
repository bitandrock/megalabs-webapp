    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Megalabs</h2>
          ...
          >
            {authLoading ? (
              ...
              <svg className="w-5 h-5 mr-3" viewBox="0 0 21 21" fill="currentColor">
                <path d="M10.0141 1.34375H9.04053V9.61426H0.769531V10.5879H9.04053V18.8584H10.0141V10.5879H18.2847V9.61426H10.0141V1.34375Z"/>
              </svg>
            )}
